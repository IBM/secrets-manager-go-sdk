	...
	Describe(`CreateConfiguration - Create a new configuration`, func() {
		...
		It(`CreateConfiguration(createConfigurationOptions *CreateConfigurationOptions)`, func() {
			configurationPrototypeModel := &secretsmanagerv2.PrivateCertificateConfigurationRootCAPrototype{
				...
				AltNames:                       []string{"s1.example.com", "*.s2.example.com"},
				IpSans:                         core.StringPtr("1.1.1.1, 2.2.2.2"),
				UriSans:                        core.StringPtr("testString"),
				OtherSans:                      []string{"2.5.4.5;UTF8:*.example.com"},
				TTL:                            core.StringPtr("8760h"),
				Format:                         core.StringPtr("pem"),
				PrivateKeyFormat:               core.StringPtr("der"),
				KeyType:                        core.StringPtr("rsa"),
				KeyBits:                        core.Int64Ptr(int64(4096)),
				MaxPathLength:                  core.Int64Ptr(int64(38)),
				ExcludeCnFromSans:              core.BoolPtr(true),
